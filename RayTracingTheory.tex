    ...
    \newpage
        ...
        \subsection{光线效果的模拟}
            ...
            \subsubsection{漫反射}
                ...
                \indent 还要随机发出一根漫反射光线来计算其光照.以交点$\overrightarrow{p_0}$为原点建立极坐标,
                其z轴正方向就是$\overrightarrow{n_hit}$,而x轴可以用$\overrightarrow{n_hit}$叉乘任意矢量
                (不与$\overrightarrow{n_hit}$共线)得到.之后利用随机数
            \subsubsection{自发光}
